...
let ItemController = class ItemController {
    ...
    async create(createItemDto, req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ItemController.prototype, "findByName", null);
__decorate([
    (0, common_1.Delete)('name/:name'),
    __param(0, (0, common_1.Param)('name')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ItemController.prototype, "deleteByName", null);
__decorate([
    (0, common_1.Patch)('name/:name/amount'),
    __param(0, (0, common_1.Param)('name')),
    __param(1, (0, common_1.Body)('amount')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], ItemController.prototype, "updateAmountByName", null);
